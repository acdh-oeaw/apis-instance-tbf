...
class Event(BaseEntity):
    ...
    date_range = FuzzyDateParserField(
        ...
        help_text=_(
            'Input has to be formatted "ab YYYY-MM-DD bis YYYY-MM-DD" '
            "for from and to date, though either date is optional and"
            "dates may also remain incomplete. Ex. ab 1982-02 bis 1982-03"
        ),
    )
