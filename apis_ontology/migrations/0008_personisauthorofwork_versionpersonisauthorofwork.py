...
class Migration(migrations.Migration):
    dependencies = [
        ("apis_ontology", "0007_event_versionevent"),
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="VersionPersonIsAuthorOfWork",
            fields=[
                (
                    "relation_ptr",
                    models.ForeignKey(
            ...
            options={
                "verbose_name": "historical person is author of work",
                "verbose_name_plural": "historical person is author of works",
